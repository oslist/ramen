...
use {
    ...
    transfer_ring::{Command, Event, RingHandler},
    x86_64::{
...
pub struct Xhci<'a> {
    ...
    command_ring: RingHandler<Command>,
    event_ring: RingHandler<Event>,
...
impl<'a> Xhci<'a> {
    ...
    fn generate(config_space: config::Space) -> Self {
        ...
        Self {
            ...
            dcbaa,
            command_ring: RingHandler::<Command>::new(),
            config_space,
            event_ring: RingHandler::<Event>::new(),
